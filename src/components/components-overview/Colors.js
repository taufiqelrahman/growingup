...
const Colors = () => (
  <Row className="mb-2">
    ...
    <Col className="mb-4">
      <div className="bg-info text-white text-center rounded p-3" style={{ boxShadow: 'inset 0 0 5px rgba(0,0,0,.2)' }}>
        Info
      </div>
    </Col>
    <Col className="mb-4">
    ...
    <Col className="mb-4">
      <div className="bg-dark text-white text-center rounded p-3" style={{ boxShadow: 'inset 0 0 5px rgba(0,0,0,.2)' }}>
        Dark
      </div>
    </Col>
  </Row>
