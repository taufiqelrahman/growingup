    ...
    return (
      <div>
        <InputGroup className="mb-3">
          <FormInput />
          <Dropdown open={this.state.dropdown1} toggle={() => this.toggle('dropdown1')} addonType="append">
        ...
        <InputGroup className="mb-3">
          <Dropdown open={this.state.dropdown2} toggle={() => this.toggle('dropdown2')} addonType="prepend">
            <DropdownToggle caret>Dropdown</DropdownToggle>
            <DropdownMenu small>
              <DropdownItem>Action</DropdownItem>
              <DropdownItem>Another action</DropdownItem>
