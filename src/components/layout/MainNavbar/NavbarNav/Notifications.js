        ...
        <Collapse open={this.state.visible} className="dropdown-menu dropdown-menu-small">
          <DropdownItem>
            ...
            <div className="notification__content">
              ...
              <p>
                Your website’s active users count increased by <span className="text-success text-semibold">28%</span>{' '}
          ...
          <DropdownItem>
            ...
            <div className="notification__content">
              ...
              <p>
                Last week your store’s sales count decreased by <span className="text-danger text-semibold">5.52%</span>
